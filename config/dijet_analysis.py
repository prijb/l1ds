...
class Config(qcd_config, cmt_config):
    ...
    def add_processes(self):
        ...
        processes = [
            ...
            Process("ztoqq_150", Label("Z' (150 GeV)"), color=(0, 0, 255), isData=False, parent_process="ztoqq"),
            Process("ztoqq_200", Label("Z' (200 GeV)"), color=(0, 0, 255), isData=False, parent_process="ztoqq"),
            Process("ztoqq_250", Label("Z' (250 GeV)"), color=(0, 0, 255), isData=False, parent_process="ztoqq"),
            Process("ztoqq_300", Label("Z' (300 GeV)"), color=(0, 0, 255), isData=False, parent_process="ztoqq"),
            Process("ztoqq_350", Label("Z' (350 GeV)"), color=(0, 0, 255), isData=False, parent_process="ztoqq"),
            Process("ztoqq_400", Label("Z' (400 GeV)"), color=(0, 0, 255), isData=False, parent_process="ztoqq"),
            ...
            Process("ztoqq_700", Label("Z' (700 GeV)"), color=(0, 0, 255), isData=False, parent_process="ztoqq"),
        ]
    ...
    def add_datasets(self):
        ...
        datasets = [
            Dataset("DataDijet25Run392526",
                folder = "/eos/cms/store/cmst3/group/daql1scout/run3/ntuples/selection/dijet30/run392526/L1ScoutingSelection",
                process = self.processes.get("data"),
                file_pattern = "l1nano(.*).root",
            ...
            Dataset("DataDijet25Run392542",
                folder = "/eos/cms/store/cmst3/group/daql1scout/run3/ntuples/selection/dijet30/run392542/L1ScoutingSelection",
                process = self.processes.get("data"),
                file_pattern = "l1nano(.*).root",
                prefix = "eoscms.cern.ch/",
                tags = ["ul"],
            ...
            Dataset("ztoqq_mlm_150_summer24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Summer24_NANOAODv15/ztoqq_mlm_150/NANOv15/260506_172444",
                process = self.processes.get("ztoqq_150"),
                prefix = "eoscms.cern.ch/",
                tags = ["ul"],
                check_empty = True,
                xs = 10000.0,
            ...
            Dataset("ztoqq_mlm_200_summer24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Summer24_NANOAODv15/ztoqq_mlm_200/NANOv15/260506_172521",
                process = self.processes.get("ztoqq_200"),
                prefix = "eoscms.cern.ch/",
                tags = ["ul"],
                check_empty = True,
                xs = 1.0,
            ...
            Dataset("ztoqq_mlm_250_winter24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Winter24_NANOAODv14/ztoqq_mlm_250/251021_011916",
            ...
            Dataset("ztoqq_mlm_250_summer24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Summer24_NANOAODv15/ztoqq_mlm_250/NANOv15/260506_172553",
                process = self.processes.get("ztoqq_250"),
                prefix = "eoscms.cern.ch/",
                tags = ["ul"],
                check_empty = True,
            ...
            Dataset("ztoqq_mlm_300_summer24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Summer24_NANOAODv15/ztoqq_mlm_300/NANOv15/260506_172719",
                process = self.processes.get("ztoqq_300"),
                prefix = "eoscms.cern.ch/",
                tags = ["ul"],
                check_empty = True,
                xs = 10000.0,
            ...
            Dataset("ztoqq_mlm_350_winter24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Winter24_NANOAODv14/ztoqq_mlm_350/251021_011948",
            ...
            Dataset("ztoqq_mlm_350_summer24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Summer24_NANOAODv15/ztoqq_mlm_350/NANOv15/260506_172746",
                process = self.processes.get("ztoqq_350"),
                prefix = "eoscms.cern.ch/",
                tags = ["ul"],
                check_empty = True,
            ...
            Dataset("ztoqq_mlm_400_summer24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Summer24_NANOAODv15/ztoqq_mlm_400/NANOv15/260506_172844",
                process = self.processes.get("ztoqq_400"),
                prefix = "eoscms.cern.ch/",
                tags = ["ul"],
                check_empty = True,
                xs = 100.0,
            ...
            Dataset("ztoqq_mlm_450_winter24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Winter24_NANOAODv14/ztoqq_mlm_450/251021_012022",
            ...
            Dataset("ztoqq_mlm_450_summer24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Summer24_NANOAODv15/ztoqq_mlm_450/NANOv15/260506_172921",
                process = self.processes.get("ztoqq_450"),
                prefix = "eoscms.cern.ch/",
                tags = ["ul"],
                check_empty = True,
            ...
            Dataset("ztoqq_mlm_500_winter24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Winter24_NANOAODv14/ztoqq_mlm_500/251021_012058",
            ...
            Dataset("ztoqq_mlm_500_summer24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Summer24_NANOAODv15/ztoqq_mlm_500/NANOv15/260506_172949",
                process = self.processes.get("ztoqq_500"),
                prefix = "eoscms.cern.ch/",
                tags = ["ul"],
                check_empty = True,
            ...
            Dataset("ztoqq_mlm_600_winter24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Winter24_NANOAODv14/ztoqq_mlm_600/251021_012143",
            ...
            Dataset("ztoqq_mlm_600_summer24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Summer24_NANOAODv15/ztoqq_mlm_600/NANOv15/260506_173017",
                process = self.processes.get("ztoqq_600"),
                prefix = "eoscms.cern.ch/",
                tags = ["ul"],
                check_empty = True,
            ...
            Dataset("ztoqq_mlm_700_summer24",
                folder = "/eos/cms/store/group/phys_exotica/l1ds/samples/ZPrime_Run3Summer24_NANOAODv15/ztoqq_mlm_700/NANOv15/260506_173046",
                process = self.processes.get("ztoqq_700"),
                prefix = "eoscms.cern.ch/",
                tags = ["ul"],
                check_empty = True,
                xs = 1.0,
    ...
    def add_features(self):
        categories = {
            ...
            "sr_pt30_wfull": "(L1Jet_pt[0] > 30) && (L1Jet_pt[1] > 30) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta < 1.06575)",
            "pt30_eta0p9": "(L1Jet_pt[0] > 30) && (L1Jet_pt[1] > 30) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047)",
            "sr_pt50_w1": "(L1Jet_pt[0] > 50) && (L1Jet_pt[1] > 50) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta < 0.02175)",
            "sr_pt50_w2": "(L1Jet_pt[0] > 50) && (L1Jet_pt[1] > 50) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta >= 0.02175) && (deta < 0.10875)",
            "sr_pt50_w3": "(L1Jet_pt[0] > 50) && (L1Jet_pt[1] > 50) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta >= 0.10875) && (deta < 0.19575)",
            "sr_pt50_w4": "(L1Jet_pt[0] > 50) && (L1Jet_pt[1] > 50) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta >= 0.19575) && (deta < 0.28275)",
            "sr_pt50_w5": "(L1Jet_pt[0] > 50) && (L1Jet_pt[1] > 50) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta >= 0.28275) && (deta < 0.36975)",
            "sr_pt50_w6": "(L1Jet_pt[0] > 50) && (L1Jet_pt[1] > 50) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta >= 0.36975) && (deta < 0.45675)",
            "sr_pt50_w7": "(L1Jet_pt[0] > 50) && (L1Jet_pt[1] > 50) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta >= 0.45675) && (deta < 0.54375)",
            "sr_pt50_w8": "(L1Jet_pt[0] > 50) && (L1Jet_pt[1] > 50) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta >= 0.54375) && (deta < 0.63075)",
            "sr_pt50_w9": "(L1Jet_pt[0] > 50) && (L1Jet_pt[1] > 50) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta >= 0.63075) && (deta < 0.71775)",
            "sr_pt50_w10": "(L1Jet_pt[0] > 50) && (L1Jet_pt[1] > 50) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta >= 0.71775) && (deta < 0.80475)",
            "sr_pt50_w11": "(L1Jet_pt[0] > 50) && (L1Jet_pt[1] > 50) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta >= 0.80475) && (deta < 0.89175)",
            "sr_pt50_w12": "(L1Jet_pt[0] > 50) && (L1Jet_pt[1] > 50) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta >= 0.89175) && (deta < 0.97875)",
        ...
        features_aux = [
            ...
            Feature("mjj_sr_barrel_full_1", "mjj",
                binning=(1000, 0, 1000),
                x_title=Label("mjj"),
                selection="(abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta < 0.4)",
            ),
            ...
            Feature("mjj_sr_wfull", "mjj",
                binning=(1000, 0, 1000),
                x_title=Label("mjj"),
                selection="(abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta < 1.06575)",
            ),
            Feature("mjj_sr_wfull_scale_corr_nominal_resolution_smear_nominal", "mjj_scale_corr_nominal_resolution_smear_nominal",
                binning=(1000, 0, 1000),
                x_title=Label("mjj"),
                selection="(abs(L1Jet_eta_scale_corr_nominal_resolution_smear_nominal[0]) < 0.957) && (abs(L1Jet_eta_scale_corr_nominal_resolution_smear_nominal[1]) < 0.957) && (dphi_scale_corr_nominal_resolution_smear_nominal > 1.047) && (deta_scale_corr_nominal_resolution_smear_nominal < 1.06575)",
            ),
            ...
            Feature("mjj_sr_eta0p9_selstream_scale_corr_nominal_resolution_smear_nominal", "mjj_scale_corr_nominal_resolution_smear_nominal",
                binning=(1000, 0, 1000),
                x_title=Label("mjj"),
                selection="(L1Jet_pt[0] > 30) && (L1Jet_pt[1] > 30) && (abs(L1Jet_eta_scale_corr_nominal_resolution_smear_nominal[0]) < 0.957) && (abs(L1Jet_eta_scale_corr_nominal_resolution_smear_nominal[1]) < 0.957) && (dphi_scale_corr_nominal_resolution_smear_nominal > 1.047) && (deta_scale_corr_nominal_resolution_smear_nominal < 0.8)",
            ),
            Feature("mjj_sr_barrel_full_1_selstream", "mjj",
                binning=(1000, 0, 1000),
                x_title=Label("mjj"),
                selection="(L1Jet_pt[0] > 30) && (L1Jet_pt[1] > 30) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta < 0.4)",
            ),
            Feature("mjj_sr_barrel_full_1_selstream_scale_corr_nominal_resolution_smear_nominal", "mjj_scale_corr_nominal_resolution_smear_nominal",
                binning=(1000, 0, 1000),
                x_title=Label("mjj"),
                selection="(L1Jet_pt[0] > 30) && (L1Jet_pt[1] > 30) && (abs(L1Jet_eta_scale_corr_nominal_resolution_smear_nominal[0]) < 0.957) && (abs(L1Jet_eta_scale_corr_nominal_resolution_smear_nominal[1]) < 0.957) && (dphi_scale_corr_nominal_resolution_smear_nominal > 1.047) && (deta_scale_corr_nominal_resolution_smear_nominal < 0.4)",
            ),
            Feature("mjj_sr_wfull_selstream", "mjj",
                binning=(1000, 0, 1000),
                x_title=Label("mjj"),
                selection="(L1Jet_pt[0] > 30) && (L1Jet_pt[1] > 30) && (abs(L1Jet_eta[0]) < 0.957) && (abs(L1Jet_eta[1]) < 0.957) && (dphi > 1.047) && (deta < 1.06575)",
            ),
            Feature("mjj_sr_wfull_selstream_scale_corr_nominal_resolution_smear_nominal", "mjj_scale_corr_nominal_resolution_smear_nominal",
                binning=(1000, 0, 1000),
                x_title=Label("mjj"),
                selection="(L1Jet_pt[0] > 30) && (L1Jet_pt[1] > 30) && (abs(L1Jet_eta_scale_corr_nominal_resolution_smear_nominal[0]) < 0.957) && (abs(L1Jet_eta_scale_corr_nominal_resolution_smear_nominal[1]) < 0.957) && (dphi_scale_corr_nominal_resolution_smear_nominal > 1.047) && (deta_scale_corr_nominal_resolution_smear_nominal < 1.06575)",
            ),
        ]
